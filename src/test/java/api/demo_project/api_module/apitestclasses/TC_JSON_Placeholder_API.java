...
import api.demo_project.api_module.apipageclasses.GET_Operation_Todos_APIDataset;
import api.demo_project.api_module.apipageclasses.GET_Operation_TodosDataset;
public class TC_JSON_Placeholder_API extends BaseClass {
	...
	public TC_JSON_Placeholder_API() throws Exception {
		PropertyConfigurator.configure("log4j.properties");
		logger = Logger.getLogger(TC_JSON_Placeholder_API.class);
	...
	public void doRequest() throws Exception { 
		...
		test = reports.startTest("TC_JSON_Placeholder_API - " + datasetNames[i-1]);
		...
		/*--------------------- GET --------------------- */
			...
			if(isExecutionFlag) {
 			 	Object object = (Object) new GET_Operation_Todos_APIDataset();
				Class<?> c = object.getClass();
				String urlParams = (String) c.getField("urlParams" + i).get(object);
				if(urlParams == null) return;
				String headers = (String) c.getField("headers" + i).get(object);
